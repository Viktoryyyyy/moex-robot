...
def projection_completeness(snapshot, value, *, now):
    ...
    from moex_data.rub_cr_futoi_dated_context import verify_projection as verify_cr_dated
    ...
    from moex_data.rub_historical_basis_carry_context import verify_projection as verify_historical_basis
