# futures_algopack_tradestats_availability_report_contract

status: implemented_contract
project: MOEX Bot
artifact_class: external_pattern
format: parquet
schema_version: futures_algopack_tradestats_availability_report.v1

purpose: Availability report for MOEX ALGOPACK futures TradeStats data by instrument, date range, and endpoint.
...
path_pattern: ${MOEX_DATA_ROOT}/futures/availability/snapshot_date={snapshot_date}/futures_algopack_tradestats_availability_report.parquet
primary_key:
...
validation_rules:
- endpoint_id must identify ALGOPACK FO tradestats.
